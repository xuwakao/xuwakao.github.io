...
function login(n) {
    ...
    return n && i > 0 && (t = t.substr(0, i)), t = t + "#" + n, location.href = "http://passport.cnblogs" + getHostPostfix() + "/login.aspx?ReturnUrl=" + encodeURIComponent(t), !1
}
function logout() {
    return confirm("确认注销吗？") && (location.href = "http://passport.cnblogs" + getHostPostfix() + "/logout.aspx?ReturnUrl=" + location.href), !1
}
function register() {
    return location.href = "http://passport.cnblogs" + getHostPostfix() + "/register.aspx?ReturnUrl=" + location.href, !1
}
...
function shBushPathPrepare() {
    for (var t = arguments, i = [], n = 0; n < t.length; n++)i.push(t[n].replace("@", "http://common.cnblogs.com/script/sh/"));
    return i
}
...
function cb_mathjax_render() {
    if (cb_enable_mathjax) {
        ...
        n.src = "http://mathjax.b0.upaiyun.com/MathJax.js?config=TeX-AMS-MML_HTMLorMML";
        t.appendChild(n)
    }
}
...
function showCopyCode(n) {
    if ($(n).height() > 120) {
        var t = '<div class="cnblogs_code_toolbar"><span class="cnblogs_code_copy"><a href="javascript:void(0);" onclick="copyCnblogsCode(this)" title="复制代码"><img src="http://wacao.cn/images/fresco-analysis/copycode.gif" alt="复制代码"/><\/a><\/span>';
...
function c_follow() {
    if (isLogined || login(), c_has_follwed)return alert("你已经关注过该博主！"), !1;
...
function loadPageBeginHtml() {
    currentBlogApp && $.ajax({
        ...
        contentType: "application/json; charset=utf-8",
        success: function (n) {
            n && (n.indexOf("<script") > -1 ? $.getScript("http://wacao.cn/javascripts/jquery.writeCapture-min.js", function () {
...
function loadBlogNews() {
    $.ajax({
        ...
        dataType: "text",
        success: function (n) {
            n && (n.indexOf("<script") < n.indexOf('<script type="text/javascript">cnblogs.UserManager.') ? $.getScript("http://wacao.cn/javascripts/jquery.writeCapture-min.js", function () {
...
function blogCommentManager() {
    ...
    this.PostNewComment = function () {
        ...
        $.ajax({
            ...
            timeout: 3e4,
            success: function (n) {
                if (n)n.IsSuccess ? (ShowCommentMsg("感谢您的回复:) 服务器端执行耗时" + n.Duration + "毫秒"), $("#tbCommentBody").val(""), $("#divCommentShow").html($("#divCommentShow").html() + n.Message)) : ShowCommentMsg(n.Message), $("#btn_comment_submit").removeAttr("disabled"); else ShowCommentMsg("抱歉！评论提交失败！请与管理员联系(contact@cnblogs.com)。"), $("#btn_comment_submit").removeAttr("disabled")
            },
            error: function (n, t) {
    ...
    this.renderComments = function (i, r, u) {
        var f = !1, e = 0, o;
        typeof u != "undefined" && (e = u, f = !0);
        !f && i == 0 && location.hash && /^#\d+$/g.test(location.hash) && (f = !0, e = location.hash.substring(1));
        i > 0 && (location.hash = "#!comments");
        o = {postId: cb_entryId, blogApp: currentBlogApp, pageIndex: i, anchorCommentId: e};
...
function GetQuoteComment(n) {
    ...
    $("#tbCommentBody").focus();
    $.getScript("http://wacao.cn/javascripts/encoder.js", function () {
...
function DelComment(n, t) {
    return confirm("确认要删除该评论吗?") && (currentDelElement = t, currentCommentID = n, $(currentDelElement).html("<span style='color:red'>正在删除...<\/span>"), $(currentDelElement).removeAttr("href"), $(currentDelElement).removeAttr("onclick"), $.ajax({
        ...
        type: "post",
        data: JSON.stringify({commentId: currentCommentID}),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (n) {
...
function incrementViewCount(n) {
    n && $.ajax({url: "http://counter.cnblogs.com/blog/post/" + n, type: "get", dataType: "script", cache: !0})
}
function runJsCode(n) {
...
function getBlogPostBody(n) {
    $.ajax({
        ...
        dataType: "text",
        success: function (t) {
            t ? ($("#postlist_postbody_" + n).html(t), cb_CodeHighlight(), cb_mathjax_render(), fixPostListBodyFormat(), n > 3861237 && $.getScript("http://common.cnblogs.com/highlight/9.0.0/highlight.min.js", function () {
...
function deliverAdC1() {
    document.referrer != null && document.referrer.indexOf("google.") > 0 && canShowAdsense() ? deliverGoogleAdC1() : deliverDirectAdC1()
}
...
insertUBB = function (n, t) {
    var r = $("#" + n).selection(), i;
    r == "" ? alert("请选择文字") : (i = t, t.indexOf("=") >= 0 && (i = t.substring(0, t.indexOf("="))), $("#" + n).parseHtml("[" + t + "]" + r + "[/" + i + "]"))
};
$(function () {
...
$(function () {
    var n = document.createElement("script"), i, t;
    n.async = !0;
    n.type = "text/javascript";
    i = "https:" == document.location.protocol;
    n.src = (i ? "https:" : "http:") + "//www.googletagservices.com/tag/js/gpt.js";
    t = document.getElementsByTagName("script")[0];
    t.parentNode.insertBefore(n, t)
})